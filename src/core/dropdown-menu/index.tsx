...
const Component = React.memo((props: IDropDownMenuProps) => {
  ...
  return (
    <div className="space-y-2">
      ...
      <select
        className="border-light-gray focus:border-light-gray w-full rounded-md border bg-light-background-gray py-2 pl-3 pr-10 text-light-blue-hover transition duration-300 ease-in focus:bg-light-background-gray focus:shadow-md focus:outline-none"
        value={selectedValue}
