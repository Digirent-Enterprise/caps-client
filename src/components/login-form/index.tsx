...
const Component = React.memo(() => {
  ...
  return (
    ...
    >
      ...
      <button
        className="focus:ring-blue flex cursor-pointer items-center justify-center rounded bg-light-background-gray border border-solid border-light-gray px-4 py-2 font-bold text-light-hover-blue hover:bg-light-gray focus:ring-2"
      ...
      <button
        className="focus:ring-blue mt-4 flex cursor-pointer items-center justify-center rounded bg-light-background-gray px-4 py-2 border border-solid border-light-gray font-bold text-light-hover-blue hover:bg-light-gray focus:ring-2"
        onClick={() => signIn("google")}
      >
        <IconBrandGoogle className="mr-2 h-8 w-8" />
        <span className="whitespace-nowrap">{t("login_with_google")}</span>
      </button>
      <div className="inline-flex w-full text-light-blue-hover items-center justify-center">
