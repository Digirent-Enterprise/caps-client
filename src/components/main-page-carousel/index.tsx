  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-center bg-light-background-gray dark:bg-dark-gray-heavy lg:px-36">
        <div className="relative flex min-h-max w-full items-center justify-center rounded-3xl rounded-b-[20%] bg-gradient-to-r from-[#169cd6] via-sky-500 via-30%  to-emerald-500 to-100% px-2	">
          <img
      ...
      <div className="mt-2 flex w-full items-center justify-center bg-light-background-gray px-36  dark:bg-dark-gray-heavy">
        <div className="flex h-full w-full items-center justify-center rounded-3xl rounded-b-[20%] bg-gradient-to-r from-[#169cd6] via-sky-500 via-30%	 to-emerald-500 to-100%	 px-2	">
          <img
