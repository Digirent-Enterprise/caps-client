...
import DashboardDiagnosisDetailModal from "@/components/dashboard/dashboard-diagnosis-detail-modal";
import { IDiagnosisCardProps } from "@/components/dashboard/dashboard-overview-diagnosis/type";
