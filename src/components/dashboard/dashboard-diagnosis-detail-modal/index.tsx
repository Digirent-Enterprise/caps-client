...
import { IDashboardDiagnosisDetail } from "@/components/dashboard/dashboard-diagnosis-detail-modal/type";
              ...
              <div className="h-full w-full max-w-screen-md ">
                <div className="relative rounded-lg bg-light-background-gray p-8 shadow-xl dark:bg-dark-blue">
                  ...
                  <div className="mt-6 flex justify-end">
                    <button
                      type="button"
                      className="ml-4 rounded-md border border-gray-400 bg-light-background-gray px-4 py-2 text-light-blue-hover hover:bg-light-gray focus:outline-none dark:hover:bg-dark-green-hover"
                      onClick={onClose}
                    >
                      Cancel
                    </button>
