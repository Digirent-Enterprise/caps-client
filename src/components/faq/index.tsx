      ...
      <div className="mb-10">
        ...
        <div className="mx-auto mt-10 max-w-3xl">
          <div className="flex flex-col gap-5">
            <section className="border-light-gray bg-light-gray flex flex-col rounded-xl border border-solid p-2 dark:border-dark-white dark:bg-dark-gray-heavy sm:p-3">
