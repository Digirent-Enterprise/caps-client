export default function Error() {
  return (
    <div className="flex h-screen w-full flex-auto flex-col items-center justify-center px-4 text-center">
      ...
      <div className="mt-2">
        <a href="/chat" className="bg-light-button-blue px-3 py-2 text-white ">
          Back to homepage
        </a>
      </div>
    </div>
