      ...
      <div className="my-10">
        ...
        <div className="mx-auto mt-10 max-w-3xl">
          ...
          <div className="rounded bg-white p-4 shadow">
            ...
            <h3 className="my-2 text-xl font-bold">{t("what_languages")}</h3>
            <p>{t("what_languages_description")}</p>

            <h3 className="my-2 text-xl font-bold">{t("key_features")}</h3>
            <p>{t("key_features_description")}</p>

            <h3 className="my-2 text-xl font-bold">{t("new_feature")}</h3>
